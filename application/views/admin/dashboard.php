...
<body>
                ...
                <!-- <div class="col-lg-6">
                    <div class="card shadow">
                        <div class="card-header bg-warning text-dark">
                            <h5 class="mb-0">📉 Out of Stock Trends</h5>
                        </div>
                        <div class="card-body">
                            <canvas id="outOfStockTrendsChart"></canvas>
                        </div>
                    </div>
                </div> -->
    ...
    var trendWeeksOrMonths = <?php echo json_encode($trend_weeks_or_months); ?>;
    var outOfStockCounts = <?php echo json_encode($out_of_stock_counts); ?>;
    </script>
