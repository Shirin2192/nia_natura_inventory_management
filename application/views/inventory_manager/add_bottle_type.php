            ...
            <div class="row page-titles mx-0">
               <div class="col p-md-0">
                  <ol class="breadcrumb">
                     ...
                     <li class="breadcrumb-item active"><a href="<?=base_url()?>admin/add_bottle_type">Add Bottle Type</a></li>
                  </ol>
               </div>
            </div>
            <!-- row -->
                           ...
                           <div class="row">
                              <div class="col-lg-6">
                                 <div class="form-group">
                                    <label class="col-form-label" for="bottle_type">Bottle Type <span class="text-danger">*</span>
                                    </label>
                                    <input type="text" class="form-control" id="bottle_type" name="bottle_type" placeholder="Enter Bottle Type ">
                                 </div>
                              </div>
                  ...
                  <form id="edit-product-form">
                     <div class="row">
                        <div class="col-lg-6 mb-3">
                           <div class="form-group">
                              <label class="col-form-label" for="edit_bottle_type">Bottle Type <span class="text-danger">*</span></label>
                              <input type="text" class="form-control" id="edit_bottle_type" name="edit_bottle_type" placeholder="Enter Bottle Type">
                           </div>
                        </div>                      
                     </div>                                       
                  </form>
