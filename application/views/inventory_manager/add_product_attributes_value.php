                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label class="col-form-label" for="fk_attribute_id">Select Attribute <span class="text-danger">*</span></label>
                                                <select class="chosen-select form-control" id="fk_attribute_id" name="fk_attribute_id" aria-placeholder="Select Attribute">
                                                    <option value=""></option>
                                                    <?php foreach ($product_attributes as $product_attributes_key => $product_attributes_row): ?>
                                                        <option value="<?= $product_attributes_row['id'] ?>"><?= $product_attributes_row['attribute_name'] ?></option>
                                                    <?php endforeach; ?>
                                                </select>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label class="col-form-label" for="attribute_value">Attribute Value <span class="text-danger">*</span></label>
                                                <input type="text" class="form-control" id="attribute_value" name="attribute_value" placeholder="Enter Attribute Name">
...
<div class="modal fade" id="editProductAttributeValueModal" tabindex="-1" role="dialog" aria-labelledby="editProductAttributeModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header bg-primary text-white">
                <h5 class="modal-title" id="editProductAttributeModalLabel">
                    <i class="icon-pencil"></i> Edit Attribute Value
                </h5>
            ...
            <div class="modal-body">
                <form id="editAttributeValueForm">
                    ...
                    <div class="form-group">
                        ...
                        <span class="form-control bg-light" id="edit_attribute_name" name="edit_attribute_name" readonly></span>
                    </div>

                    <!-- Attribute Name -->
                    <div class="form-group">
                        <label for="edit_attribute_value">Attribute Value Name</label>
                        <input type="text" class="form-control" id="edit_attribute_value" name="edit_attribute_value" placeholder="Enter Attribute Value Name" required>
...
<div class="modal fade" id="deleteProductAttributeValueModal" tabindex="-1" role="dialog" aria-labelledby="deleteProductAttributeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
