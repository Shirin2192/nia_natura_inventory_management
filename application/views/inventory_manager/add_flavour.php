            ...
            <div class="row page-titles mx-0">
               <div class="col p-md-0">
                  <ol class="breadcrumb">
                     ...
                     <li class="breadcrumb-item active"><a href="<?=base_url()?>admin/add_flavour">Add Flavour</a></li>
                  </ol>
               </div>
            </div>
            <!-- row -->
                           ...
                           <div class="row">
                              <div class="col-lg-6">
                                 <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="flavour_name" name="flavour_name" placeholder="Enter Flavour Name ">
                                 </div>
                              </div>
