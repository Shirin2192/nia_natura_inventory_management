            ...
            <div class="row page-titles mx-0">
               <div class="col p-md-0">
                  <ol class="breadcrumb">
                     ...
                     <li class="breadcrumb-item active"><a href="<?=base_url()?>admin/add_bottle_size">Add Bottle Size</a></li>
                  </ol>
               </div>
            </div>
            <!-- row -->
                           ...
                           <div class="row">
                              <div class="col-lg-6">
                                 <div class="form-group">
                                    <label class="col-form-label" for="bottle_size">Bottle Size <span class="text-danger">*</span>
                                    </label>
                                    <input type="text" class="form-control" id="bottle_size" name="bottle_size" placeholder="Enter Bottle Size ">
                                 </div>
                              </div>
                     ...
                     <div class="row">
                        <div class="col-lg-6 mb-3">
                           <div class="form-group">
                              ...
                              <input type="text" class="form-control" id="edit_bottle_size" name="edit_bottle_size" placeholder="Enter Bottle Size">
                           </div>
                        </div>                      
                     </div>                                       
                  </form>
