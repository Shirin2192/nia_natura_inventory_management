...
public function get_product_detail()
{
    ...
    public function get_product_by_id($product_id) {
        $this->db->select('
            ...
            GROUP_CONCAT(DISTINCT tbl_product_types.product_type_name) as product_type_name,
            GROUP_CONCAT(DISTINCT tbl_attribute_values.attribute_value) as attribute_value,
            GROUP_CONCAT(DISTINCT tbl_product_price.purchase_price ORDER BY tbl_product_price.fk_batch_id ASC) as purchase_price,
            GROUP_CONCAT(DISTINCT tbl_product_price.MRP ORDER BY tbl_product_price.fk_batch_id ASC) as MRP,
            GROUP_CONCAT(DISTINCT tbl_product_price.selling_price ORDER BY tbl_product_price.fk_batch_id ASC) as selling_price,
            GROUP_CONCAT(DISTINCT tbl_product_price.id ORDER BY tbl_product_price.fk_batch_id ASC) as product_price_id,
            
            GROUP_CONCAT(DISTINCT tbl_product_inventory.total_quantity ORDER BY tbl_product_inventory.fk_batch_id ASC) as total_quantity,
            ...
            GROUP_CONCAT(DISTINCT tbl_product_batches.expiry_date ORDER BY tbl_product_batches.id ASC) as expiry_date,
            GROUP_CONCAT(DISTINCT tbl_product_batches.manufactured_date ORDER BY tbl_product_batches.id ASC) as manufactured_date,
