...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 28, 2025 at 12:04 PM
...
CREATE TABLE `tbl_attribute_values` (
  `id` int(11) NOT NULL,
  `fk_product_attribute_id` int(11) DEFAULT NULL,
...
(12, ' Kashmir White', 1, '1', '2025-03-25 06:34:05', '2025-03-26 07:29:03'),
...
INSERT INTO `tbl_product_attributes` (`id`, `fk_product_type_id`, `attribute_name`, `attribute_type`, `status`, `is_delete`, `created_at`, `updated_at`) VALUES
...
(1, 1, 1, 1, 1, NULL, 50, NULL, 50, 0, '0', '2025-03-25 07:14:10', '2025-03-26 06:48:40'),
(2, 1, 1, 1, 1, NULL, 100, NULL, 150, 1, '1', '2025-03-26 06:43:27', '2025-03-26 08:32:31');
...
(1, 1, 1, 1, 500, 600, 600, 1, '1', '2025-03-25 07:14:10', '2025-03-26 08:32:39');
...
INSERT INTO `tbl_sale_channel` (`id`, `sale_channel`, `status`, `is_delete`, `created_at`, `updated_at`) VALUES
(1, 'Amazon', 1, '1', '2025-03-25 03:59:32', '2025-03-25 04:06:08'),
(2, 'Flipkart', 1, '1', '2025-03-25 07:24:09', '2025-03-25 07:24:09'),
(3, 'Offline', 1, '1', '2025-03-25 07:24:17', '2025-03-25 07:24:17');
...
ALTER TABLE `tbl_attribute_values`
  ADD PRIMARY KEY (`id`),
  ADD KEY `id` (`id`,`fk_product_attribute_id`,`value_name`);
